...
const execute = async (bot, message, args) => {
    ...
    let supportCategory = message.guild.channels.cache.get("730183165565599804");
    ...
    message.guild.channels.create(channelName, { parent: '730183165565599804', topic: `Ticket Owner: ${message.author.id}`}).then(c => {
        
        const sr = message.guild.roles.cache.get('735948897389772952') // Id do cargo do bot
